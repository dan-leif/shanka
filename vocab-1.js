...
"Lesson 2-5": [
  ...
  {en:"worthwhile", trad:"值得", simp:"值得", py:"zhídé"}
    ...
    "Lesson 2-8": [
      {en:"even", trad:"連", simp:"连", py:"lián"},
      {en:"shadow", trad:"影子", simp:"影子", py:"yǐngzi"},
      {en:"research report", trad:"研究報告", simp:"研究报告", py:"yánjiū bàogào"},
      {en:"relieved, relaxed", trad:"輕鬆", simp:"轻松", py:"qīngsōng"},
      {en:"cousin", trad:"表妹", simp:"表妹", py:"biǎomèi"},
      {en:"better than, well off, strong", trad:"強", simp:"强", py:"qiáng"},
      {en:"to finish", trad:"完", simp:"完", py:"wán"},
      {en:"director; to direct (a film)", trad:"導演", simp:"导演", py:"dǎoyǎn"},
      {en:"(measure word for films, machines, or cars)", trad:"部", simp:"部", py:"bù"},
      {en:"action movie, kung fu movie", trad:"功夫片", simp:"功夫片", py:"gōngfupiān"},
      {en:"major, main", trad:"主要", simp:"主要", py:"zhǔyào"},
      {en:"very, especially", trad:"特別", simp:"特别", py:"tèbié"},
      {en:"it", trad:"它", simp:"它", py:"tā"},
      {en:"scene", trad:"場面", simp:"场面", py:"chǎngmiàn"},
      {en:"story, plot", trad:"情節", simp:"情节", py:"qíngjié"},
      {en:"appealing, attractive", trad:"吸引人", simp:"吸引人", py:"xīyǐnrén"},
      {en:"about, with regard to", trad:"關於", simp:"关于", py:"guānyú"},
      {en:"ancient", trad:"古代", simp:"古代", py:"gǔdài"},
      {en:"story", trad:"故事", simp:"故事", py:"gùshi"},
      {en:"to be inferior to, to be not as good as", trad:"不如", simp:"不如", py:"bùrú"},
      {en:"brilliant, wonderful", trad:"精彩", simp:"精彩", py:"jīngcǎi"},
      {en:"toward, to", trad:"對", simp:"对", py:"duì"},
      {en:"description, exposition; to describe", trad:"描寫", simp:"描写", py:"miáoxiě"},
      {en:"history", trad:"歷史", simp:"历史", py:"lìshǐ"},
      {en:"to agree", trad:"同意", simp:"同意", py:"tóngyì"},
      {en:"factual, objective", trad:"客觀", simp:"客观", py:"kèguān"},
      {en:"to feel, sense", trad:"感", simp:"感", py:"gǎn"},
      {en:"interest", trad:"興趣", simp:"兴趣", py:"xìngqù"},
      {en:"emotion", trad:"感情", simp:"感情", py:"gǎnqíng"},
      {en:"aspect", trad:"方面", simp:"方面", py:"fāngmiàn"},
      {en:"and also, furthermore", trad:"而且", simp:"而且", py:"érqiě"},
      {en:"special technique", trad:"特技", simp:"特技", py:"tèjì"},
      {en:"effect", trad:"效果", simp:"效果", py:"xiàoguǒ"},
      {en:"color", trad:"顏色", simp:"颜色", py:"yánsè"},
      {en:"weekend", trad:"週末", simp:"周末", py:"zhōumò"},
      {en:"to show (movies), to place", trad:"放", simp:"放", py:"fàng"},
      {en:"ticket price", trad:"票價", simp:"票价", py:"piàojià"}
    ]
  }
};
